#ifndef MC_FAULT_CODES_HPP
#define MC_FAULT_CODES_HPP
#include <Arduino.h>
...
public:
    ...
    void print()
    {
        ...
        Serial.println(post_fault_lo, HEX);
        Serial.print("POST FAULT HI: 0x");
        Serial.println(post_fault_hi, HEX);
        Serial.print("RUN FAULT LO:  0x");
        Serial.println(run_fault_lo, HEX);
        Serial.print("RUN FAULT HI:  0x");
        Serial.println(run_fault_hi, HEX);
    }
#endif
