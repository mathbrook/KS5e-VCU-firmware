#ifndef MC_MOTOR_POS_INFO_H
#define MC_MOTOR_POS_INFO_H
#include <Arduino.h>
...
public:
    ...
    void print()
    {
        ...
        Serial.println(motor_angle / 10.0, 1);
        Serial.print("MOTOR SPEED:         ");
        Serial.println(motor_speed);
        Serial.print("ELEC OUTPUT FREQ:    ");
        Serial.println(electrical_output_frequency);
        Serial.print("DELTA RESOLVER FILT: ");
        Serial.println(delta_resolver_filtered);
    }
#endif
