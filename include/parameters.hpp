...
#define START_ACCELERATOR_PEDAL_1 1965  // Position to start acceleration
#define END_ACCELERATOR_PEDAL_1 2600    // Position to max out acceleration
...
#define START_ACCELERATOR_PEDAL_2 1297  // Position to start acceleration
#define END_ACCELERATOR_PEDAL_2 1690    // Position to max out acceleration
