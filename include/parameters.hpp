...
#define END_ACCELERATOR_PEDAL_1 1800    // Position to max out acceleration
...
#define END_ACCELERATOR_PEDAL_2 2000    // Position to max out acceleration
#define MAX_ACCELERATOR_PEDAL_2 3200    // High accelerator implausibility threshold
